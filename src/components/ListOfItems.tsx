...
export const ListOfItems = ({ placeOrderDetails, goToShipping, closeModal, removeFromCart }: ListOfItemsProps) => {
            ...
            {lineItems.map((lineItem, i) => {
              return (
                ...
                >
                  ...
                  <UiEntity uiTransform={{ width: '100%', height: '20%', display: 'flex' }}>
                    <UiEntity
                      uiTransform={{
                        width: '100%',
                        height: '50%'
