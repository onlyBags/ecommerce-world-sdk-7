...
export const SuccessModal = ({ btnHandler, message, buttonText = 'ok' }: SuccessModalProps) => {
  return (
    <UiEntity
      uiTransform={{
        width: '100%',
      ...
      >
        <UiEntity
          uiBackground={{
            textureMode: 'stretch',
            texture: {
              src: 'images/success/Success.png'
            }
          }}
        ...
        <UiEntity
          ...
          uiText={{ value: message || 'Ok', fontSize: 16, color: Color4.Black() }}
        />
