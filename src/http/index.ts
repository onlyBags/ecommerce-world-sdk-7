...
class Http {
  ...
  async request<T>(url: string, method: HttpMethod, data?: any, options?: HttpOptions): Promise<T> {
  ...
  post<T>(url: string, data: any, options?: HttpOptions): Promise<DGLiveResponse<T>> {
